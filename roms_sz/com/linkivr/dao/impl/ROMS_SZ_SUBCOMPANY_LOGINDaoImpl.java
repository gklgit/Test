...
@Component("romsszsubcompanyloginDao")
public class ROMS_SZ_SUBCOMPANY_LOGINDaoImpl implements
		ROMS_SZ_SUBCOMPANY_LOGINDao {
	...
	private SessionFactory sessionFactory;
	  ...
	  {
	    String hql = "from ROMS_SZ_SUBCOMPANY_LOGIN order by id";
	  ...
	  {
	    String hql = "select count(*) from ROMS_SZ_SUBCOMPANY_LOGIN where 1=1 " + where;
	    System.out.println(hql);
	  ...
	  public int delete(String id)  {
			...
			return  sessionFactory.getCurrentSession()
			.createQuery("delete ROMS_SZ_SUBCOMPANY_LOGIN  where id=:id ")
			.setString("id", id)
			.executeUpdate();
		}
	  ...
	  {
	    String hql = "from ROMS_SZ_SUBCOMPANY_LOGIN where  id=:id";
	    System.out.println(hql);
	    System.out.println("id=" + id);
	    return (ROMS_SZ_SUBCOMPANY_LOGIN)sessionFactory.getCurrentSession()
	      .createQuery(hql)
	      .setString("id", id)
	      .uniqueResult();
	  }
	  ...
	  {
	    String hql = "from ROMS_SZ_SUBCOMPANY_LOGIN where 1=1 " + where;
	    System.out.println(hql);
	    return (ROMS_SZ_SUBCOMPANY_LOGIN)sessionFactory.getCurrentSession()
	      .createQuery(hql)
	      .uniqueResult();
