...
@Component("romsszdocDao")
public class ROMS_SZ_DOCDaoImpl implements ROMS_SZ_DOCDao {
	...
	private SessionFactory sessionFactory;
	  ...
	  {
	    String hql = "from ROMS_SZ_DOC order by id";
	  ...
	  {
	    String hql = "select count(*) from ROMS_SZ_DOC where 1=1 " + where;
	    System.out.println(hql);
	  ...
	  {
	    this.sessionFactory.getCurrentSession().merge(doc);
	  }
	  
	  public int delete(String id)  {
			
			return  sessionFactory.getCurrentSession()
			.createQuery("delete ROMS_SZ_DOC  where id=:id ")
			.setString("id", id)
			.executeUpdate();
		}
	  ...
	  {
	    String hql = "from ROMS_SZ_DOC where  id=:id";
	    System.out.println(hql);
	    System.out.println("id=" + id);
	    return (ROMS_SZ_DOC)sessionFactory.getCurrentSession()
	      .createQuery(hql)
	      .setString("id", id)
	      .uniqueResult();
	  }
	  ...
	  {
	    String hql = "from ROMS_SZ_DOC where 1=1 " + where;
	    System.out.println(hql);
	    return (ROMS_SZ_DOC)sessionFactory.getCurrentSession()
	      .createQuery(hql)
	      .uniqueResult();
