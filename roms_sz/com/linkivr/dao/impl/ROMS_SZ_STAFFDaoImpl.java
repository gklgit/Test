...
@Component("romsszstaffDao")
public class ROMS_SZ_STAFFDaoImpl implements ROMS_SZ_STAFFDao {
	...
	private SessionFactory sessionFactory;
	  ...
	  {
	    String hql = "from ROMS_SZ_STAFF order by id";
	  ...
	  {
	    String hql = "select count(*) from ROMS_SZ_STAFF where 1=1 " + where;
	    System.out.println(hql);
	  ...
	  {
	    this.sessionFactory.getCurrentSession().merge(staff);
	  }
	  
	  public int delete(String id)  {
			
			return  sessionFactory.getCurrentSession()
			.createQuery("delete ROMS_SZ_STAFF  where id=:id ")
			.setString("id", id)
			.executeUpdate();
		}
	  ...
	  {
	    String hql = "from ROMS_SZ_STAFF where  id=:id";
	    System.out.println(hql);
	    System.out.println("id=" + id);
	    return (ROMS_SZ_STAFF)sessionFactory.getCurrentSession()
	      .createQuery(hql)
	      .setString("id", id)
	      .uniqueResult();
	  }
	  ...
	  {
	    String hql = "from ROMS_SZ_STAFF where 1=1 " + where;
	    System.out.println(hql);
	    return (ROMS_SZ_STAFF)sessionFactory.getCurrentSession()
	      .createQuery(hql)
	      .uniqueResult();
